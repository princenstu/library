...
<div align="center" style=" margin-top:50px;">
	...
	if($this->session->userdata('logged_in')==true)
	{
		...
		echo "<div><a href='index.php/library/logout/' style='text-decoration:none;'> <button type='button' name='button'>Logout</button></a></div>";
	}
	else
	{
			...
			?>
				<table style="border-bottom:1px solid #cccccc;">
					<tr>
						...
						<td width="52%" valign="top" style="color:#3A66A0;"><?php echo $row->ebooks; ?><br>
						...
						<td width="20%" valign="top" style="border-left:1px solid #cccccc;">total downdload</td>
						<td width="20%" valign="top" align="right"><a href="<?php echo base_url(); ?>uploads/ebooks/<?php echo $row->ebook_file; ?>" ><img border="0" src="<?php echo base_url();?>system/application/views/images/download.jpg" width="18" height="20" align="texttop" alt="" />&nbsp;<b style="color:#3A66A0;">Download</b></a></td>
					</tr>
				</table>
			<?php
				}

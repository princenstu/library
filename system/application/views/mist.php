...
<li><a href="index.php/library/facilities">Facilities</a></li>
<li><a href="index.php/library/hours">Operating Hours</a></li>
<li><a href="index.php/library/rules">Rules & Regulation</a></li>
<li><a href="index.php/library/search_all">Search</a></li>
<li><a href="index.php/library/profile">Profile</a></li>
</ul>
...
<li><a href="#">Sub-menu</a></li>
   ...
   <div id="login_content">
	...
	if($this->session->userdata('logged_in')==true)
	{
		...
		<?php
		echo "Welcome,<br>";
		echo "<b>".$this->session->userdata('username')."</b><br>";
		echo "<a href='index.php/library/logout/'> Logout</a>";
		?>
		</div>
		<?php
	}
